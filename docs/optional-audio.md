...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Over 5 hours of new material specially composed to alter the atmosphere of the game to a darker tone.</p>
    
    <ul>
      <li>Download the optional file <span class="highlight">Digital_Nightmare_1-5</span></li>
	  <li>Download the update file <span class="highlight">ESP_FIX</span></li>
    </ul>
...
<div style="display: flex; gap: 20px; margin-bottom: 20px;">
  <div style="flex: 1; background:#2b2925; padding:10px; border-radius:5px;">
    ...
    <ul>
      <li>Download the main file <span class="highlight">Journey of the Survivor - RACE Music Pack</span></li>
      <li>Requires <span class="highlight">Radio Active Channel Extender</span>; install that first. Use <span class="highlight">R.A.C.E</span>'s settings object in your inventory to change the song limit to 30.</li>
    </ul>
  </div>
  ...
  <div style="flex: 1; background:#2b2925; border-radius:5px; overflow:hidden; display:flex; flex-direction:column; border: 1px solid hsl(50, 80%, 45%);">
    <div class="infobox-requirement" style="margin:0; border-radius:0; border:none; flex:1;">
      ...
      <div class="infobox-content" style="padding: 10px;">
        ...
        <ul>
          <li>Download the main file <span class="highlight">RACE - Main File (no music included)</span></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>A full replacement of all ballistic, explosive and energy weapon sounds.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">AWSOMER</span></li>
    </ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Removes the wind-up sound from miniguns.</p>
