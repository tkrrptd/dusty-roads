...
<div style="display: flex; gap: 0; margin-bottom: 20px;">
  <div style="flex: 1; background:#2b2925; padding:10px; border-radius:5px 0 0 5px;">
    ...
    <ol>
	  ...
	  <li><img src="/images/settings.png" alt="Open list options"> Click the <code>Open list options...</code> button on top of the left pane in <span class="highlight">MO2</span> (not the toolbar!), and select <code>Create empty mod</code></li>
  ...
  <div style="flex: 1; background:#2b2925; padding:10px; border-radius:0 5px 5px 0; display: flex; align-items: center; justify-content: center;">
    <img src="/images/xlodgen-worldspaces.png" style="max-width: 100%; height: auto;">
...
<div style="background:#2b2925; padding:10px; border-radius:5px; margin-bottom:20px;">
  ...
  <div style="display: flex; gap: 0; margin-bottom: 10px;">
    <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
      <img src="/images/xlodgen-lod4.png" alt="LOD4" style="max-width: 100%; height: auto;">
    </div>
    <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
      <img src="/images/xlodgen-lod8.png" alt="LOD8" style="max-width: 100%; height: auto;">
    </div>
  </div>

  <div style="display: flex; gap: 0;">
    <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
      <img src="/images/xlodgen-lod16.png" alt="LOD16" style="max-width: 100%; height: auto;">
    </div>
    <div style="flex: 1; display: flex; align-items: center; justify-content: center;">
      <img src="/images/xlodgen-lod32.png" alt="LOD32" style="max-width: 100%; height: auto;">
    </div>
  </div>
...
<div style="display: flex; gap: 0; margin-bottom: 20px;">
  ...
  <div style="flex: 1; background:#2b2925; padding:10px; border-radius:0 5px 5px 0; display: flex; align-items: center; justify-content: center;">
    <img src="/images/xlodgen-object.png" alt="Objects and Trees LOD" style="max-width: 100%; height: auto;">
...
<div style="display: flex; gap: 0; margin-bottom: 20px;">
  ...
  <div style="flex: 1; background:#2b2925; padding:10px; border-radius:0 5px 5px 0; display: flex; align-items: center; justify-content: center;">
    <img src="/images/bsarchpro-obj.png" alt="BSArchPro Settings" style="max-width: 75%; height: auto;">
...
<div style="display: flex; gap: 0; margin-bottom: 20px;">
  ...
  <div style="flex: 1; background:#2b2925; padding:10px; border-radius:0 5px 5px 0; display: flex; align-items: center; justify-content: center;">
    <img src="/images/bsarchpro-ter.png" alt="BSArchPro Settings" style="max-width: 75%; height: auto;">
