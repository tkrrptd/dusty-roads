...
<div style="background:#2b2925; border-radius:5px; margin-bottom:20px;">
  ...
  <div style="display: flex; gap: 10px; padding: 0 10px 10px 10px;">
    ...
    <div style="flex:1; border: 1px solid hsl(50, 80%, 45%); border-radius:5px; overflow:hidden;">
      <div class="infobox-requirement" style="margin:0; border-radius:0; border:none;">
        ...
        <div class="infobox-content" style="padding:10px;">
          ...
          <ul>
            <li>Download the main file <span class="highlight">AnhNVSE v1.3.1</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div style="flex:1; border: 1px solid hsl(50, 80%, 45%); border-radius:5px; overflow:hidden;">
      <div class="infobox-requirement" style="margin:0; border-radius:0; border:none;">
        ...
        <div class="infobox-content" style="padding:10px;">
          ...
          <ul>
            <li>Download the main file <span class="highlight">SUP NVSE Plugin</span></li>
          </ul>
        </div>
      </div>
    </div>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>The sandstorms in the Mojave, Strip, and Jacobstown will be automatically enabled at the start of the game.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Mojave Sandstorms - DUST Expansion Project</span></li>
	</ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>A weather mod which takes the oppressive atmosphere of the Sierra Madre Villa and brings it to the Mojave.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">This Corrosion</span></li>
	  <li>Download the optional file <span class="highlight">This Corrosion - DUST Patch</span></li>
	</ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Paint the town red, blood splats, splatters and pools reimagined in high quality textures.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Bloodbath (Realism) - 2K</span> (or 1K version, depending on your system)</li>
    </ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Overhauls the game's screen blood system.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Screen Blood Enhanced</span></li>
	  <li>Download the main file <span class="highlight">Screen Blood Enhanced - INI</span></li>
    </ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Adds various dynamic conditional effects to the Pip-Boy screen.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Pip-Boy Screen Effects</span></li>
	  <li>Download the main file <span class="highlight">Pip-Boy Screen Effects - INI</span></li>
    </ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Adds a customizable visual effect when the player is exposed to radiation.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Radiation Visuals</span></li>
	  <li>Download the main file <span class="highlight">Radiation Visuals - INI</span></li>
    </ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Adds vignette to the screen while the player is sneaking.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Sneak Vignette</span></li>
	  <li>Download the main file <span class="highlight">Sneak Vignette - INI</span></li>
    </ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Adds a Depth of Field (DoF) effect to Just Loot Menu.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Just Loot Menu DoF</span></li>
	</ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Improves terrain shading by adding specular lighting, per-pixel fog, and ups the pointlight limit from 3 to 24.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Vanilla Plus Terrain</span></li>
	  <li>Download the optional file <span class="highlight">Vanilla Plus Terrain - Textures</span></li>
	</ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Improves skin shading by using preintegrated subsurface scattering, removes the unnatural glow around faces.</p>
    
    <ul>
      <li>Download the main file <span class="highlight">Vanilla Plus Skin</span></li>
	</ul>
...
<div class="guide-box">
  ...
  <div style="margin-top: 0;">
    <p>Vanilla friendly overhaul of every single landscape texture to make use of parallax.</p>
